# Generated by Django 2.1.3 on 2018-12-11 03:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_url', models.CharField(default='https://s3-us-west-2.amazonaws.com/myroadmap.io/images/profiles/nobody.jpg', max_length=255)),
        ...
        migrations.AddField(
            model_name='meeting',
            name='person',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meetings', to='app.Person'),
        ),
        migrations.AddField(
            model_name='meeting',
            name='user',
